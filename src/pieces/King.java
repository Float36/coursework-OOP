...
public class King extends Piece{
    ...
    // перевіряємо чи наш король може ракеруватися
            ...
            if (col == 6) {
                ...
                if (rock != null && rock.isFirstMove && isFirstMove) {
                    return board.getPiece(5, row) == null &&
                            ...
                            !board.checkScanner.isKingChacked(new Move(board, this, 5, row));
                }
            } else if (col == 2) {
                ...
                if (rock != null && rock.isFirstMove && isFirstMove) {
                    return board.getPiece(3, row) == null &&
                            ...
                            !board.checkScanner.isKingChacked(new Move(board, this, 3, row));
                }
            }
        }
